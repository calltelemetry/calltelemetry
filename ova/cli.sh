...
apply_postgres_profile() {
  ...
  case "$profile" in
    ...
    large)
      ...
      env_set "PG_SHM_SIZE" "12gb"
      env_set "PG_SHARED_BUFFERS" "8GB"
      env_set "PG_EFFECTIVE_CACHE_SIZE" "24GB"
      env_set "PG_WORK_MEM" "64MB"
      env_set "PG_MAINTENANCE_WORK_MEM" "2GB"
      env_set "PG_WAL_BUFFERS" "256MB"
      env_set "PG_PARALLEL_WORKERS" "8"
      env_set "PG_MAX_PARALLEL_WORKERS" "16"
      env_set "PG_AUTOVACUUM_WORKERS" "8"
